...
class Ui_gui_main(object):
    def setupUi(self, gui_main):
        ...
        self.lb_temp.setGeometry(QRect(0, 20, 901, 81))
        font1 = QFont()
        ...
        self.lb_humidity.setGeometry(QRect(0, 130, 951, 121))
        font2 = QFont()
        ...
        self.lb_level.setGeometry(QRect(0, 290, 971, 71))
        self.lb_level.setFont(font2)
        self.label = QLabel(self.centralwidget)
        self.label.setObjectName(u"label")
        self.label.setGeometry(QRect(0, 410, 991, 101))
